...
## ব্যাকএন্ড: Google Sheet + Drive দিয়ে ডেটা কালেকশন

`register.html`, `contact.html` ও `tools.html` (NID আপলোড) এখন সত্যিকারের ডেটা জমা নেয় —
Google Sheet-এ টেক্সট ডেটা আর Google Drive-এ ছবি জমা হয়।

সেটআপ করতে **google-apps-script/Code.gs** ফাইলটা একটা Google Sheet-এর Apps Script এ পেস্ট করুন,
`SHEET_ID` ও `DRIVE_FOLDER_ID` বসান, Web App হিসেবে Deploy করুন, তারপর সেই URL
**assets/config.js** ফাইলে বসান। বিস্তারিত ধাপে ধাপে গাইড চ্যাটে দেওয়া আছে।

> নিরাপত্তা নোট: রেজিস্টার ফর্মের পাসওয়ার্ড ঘরটা এখনো ব্যাকএন্ডে পাঠানো হয় না (Google Sheet
> পাসওয়ার্ড সংরক্ষণের নিরাপদ জায়গা না)। সত্যিকারের লগইন/অথেনটিকেশনের জন্য Firebase Auth বা
> এই ধরনের একটা সেবা যুক্ত করতে হবে।
